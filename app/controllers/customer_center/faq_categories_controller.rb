  ...
  def create
    ...
    respond_to do |format|
      if @faq_category.save
        format.html { redirect_to customer_center_faqs_url(:faq_category_id=>@faq_category), :notice=> @controller_name +t(:message_success_create)}
  ...
  def update
    respond_to do |format|
      if @faq_category.update_attributes(faq_category_params)
        format.html { redirect_to customer_center_faqs_url(:faq_category_id=>@faq_category), :notice=> @controller_name +t(:message_success_update)}
        format.json { head :ok }
      else
