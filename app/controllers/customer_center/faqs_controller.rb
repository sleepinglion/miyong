...
class CustomerCenter::FaqsController < BoardController
  ...
  def create
    ...
    respond_to do |format|
      if @faq.save
        format.html { redirect_to customer_center_faqs_url(:faq_category_id=>@faq.faq_category.id), :notice=> @controller_name +t(:message_success_create)}
  ...
  def update
    ...
    respond_to do |format|
      if @faq.update_attributes(faq_params)
        format.html { redirect_to customer_center_faqs_url(:faq_category_id=>@faq.faq_category.id), :notice=> @controller_name +t(:message_success_update)}
        format.json { head :ok }
      else
